...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaleight/ \
                                     --checkfiles DisplaySymbols.java --singlecomments 5 --multicomments 3 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date(" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaleight/ \
                                     --checkfiles DisplaySymbols.java --fragments "new Date(" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "println(" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaleight/ \
                                     --checkfiles DisplaySymbols.java --fragments "println(" --fragmentcounts 10
  determine_exit_code $?
  # --> GatorGrader CHECK: the "displaySymbolInTriangle" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaleight/ \
                                     --checkfiles DisplaySymbols.java --fragments "displaySymbolInTriangle" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "displaySymbolInDoubleTriangle" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicaleight/ \
                                     --checkfiles DisplaySymbols.java --fragments "displaySymbolInDoubleTriangle" --fragmentcounts 2
  determine_exit_code $?
  echo ""
